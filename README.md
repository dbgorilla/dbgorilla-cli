...
### On-prem / air-gapped (recommended for enterprise)
...
- The one-paste install path (`curl https://<your-deployment>/install.sh | sh`) requires your DBGorilla deployment to serve a matching install script and binaries. Until then, install via Homebrew or download a binary from [Releases](https://github.com/dbgorilla/dbgorilla-cli/releases).
